...
class SavingsControllerTest < ActionController::TestCase
  ...
  test "should create saving" do
    assert_difference('Saving.count') do
      post :create, saving: { amount: @saving.amount, dateTime: @saving.dateTime, memberId: @saving.memberId, orNumber: @saving.orNumber, savingsId: @saving.savingsId, staffed: @saving.staffed }
    end
  ...
  test "should update saving" do
    patch :update, id: @saving, saving: { amount: @saving.amount, dateTime: @saving.dateTime, memberId: @saving.memberId, orNumber: @saving.orNumber, savingsId: @saving.savingsId, staffed: @saving.staffed }
    assert_redirected_to saving_path(assigns(:saving))
  end
